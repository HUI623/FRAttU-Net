...
# 测试代码
def main():
    tr_path_raw = '/liver_segmentation_gai/fixed/save/tr/raw'
    tr_path_label = '/liver_segmentation_gai/fixed/save/tr/label'
    ts_path_raw = '/iver_segmentation_gai/fixed/save/ts/raw'
    ts_path_label = '//liver_segmentation_gai/fixed/save/ts/label'
